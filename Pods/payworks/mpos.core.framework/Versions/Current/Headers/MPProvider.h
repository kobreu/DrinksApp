 ...
 * @deprecated 2.6.0
 */
typedef void (^MPTransactionReceiptQuerySuccess)(NSString * _Nonnull transactionIdentifier, MPReceipt * _Nonnull receipt) DEPRECATED_ATTRIBUTE;
 ...
 * @deprecated 2.6.0
 */
typedef void (^MPTransactionReceiptQueryFailure)(NSString * _Nonnull transactionIdentifier, NSError * _Nonnull error) DEPRECATED_ATTRIBUTE;
 ...
 * @deprecated 2.6.0
 */
- (void)lookupTransactionsWithCustomIdentifier:(nonnull NSString *)customIdentifier success:(nonnull MPTransactionsLookupSuccess)success failure:(nonnull MPTransactionsLookupFailure)failure DEPRECATED_MSG_ATTRIBUTE("Use queryTransactionsUsingFilters:includeReceipts:range:success:failure: to query transactions with receipts attached");
 ...
 * @deprecated  2.6.0
 */
- (void)queryTransactionReceiptByTransactionIdentifier:(nonnull NSString *)transactionIdentifier receiptType:(MPReceiptType)receiptType success:(nonnull MPTransactionReceiptQuerySuccess)success failure:(nonnull MPTransactionReceiptQueryFailure)failure DEPRECATED_MSG_ATTRIBUTE("Use lookupTransactionWithTransactionIdentifier to query transaction with receipts attached");
