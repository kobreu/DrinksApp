 ...
 * @since 2.7.0
 */
typedef NS_ENUM(NSUInteger, MPMockConfigurationTippingComponentBehaviour) {

    /** Asking for tip succeeds with suggested tip amount if provided, else with a tip amount of 1 */
    MPMockConfigurationTippingComponentBehaviourTipEntered = 0,
    /** Customer refuses to tip*/
    MPMockConfigurationTippingComponentBehaviourNoTip,
    /** Asking for tip fails with an error*/
    MPMockConfigurationTippingComponentBehaviourError
};
...
/**
 * The behaviour of the tipping component
 * @since 2.7.0
 */
@property (assign, nonatomic) MPMockConfigurationTippingComponentBehaviour tippingComponentBehaviour;
