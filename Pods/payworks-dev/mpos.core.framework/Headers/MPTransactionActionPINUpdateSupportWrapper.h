...
/**
 * Wrapper for PIN update actions, providing access to PIN information.
 * @since 2.0.0
 */
@interface MPTransactionActionPINUpdateSupportWrapper : MPAbstractTransactionActionSupportWrapper
